...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      'text-center text-lg font-bold leading-none tracking-tight text-[24px] ',
      className
    )}
    {...props}
  />
